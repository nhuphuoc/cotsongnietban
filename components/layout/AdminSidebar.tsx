...
import {
  LayoutDashboard, Users, ShoppingCart, FileText, LogOut, MessageSquareQuote, Clapperboard, Menu, X, TicketPercent
} from "lucide-react";
  ...
  const renderNav = () => (
    <>
      ...
      <div className="p-3 border-t border-gray-200 space-y-0.5">
        <Link prefetch={false} href="/auth/signout" className="flex items-center gap-3 px-3 py-2.5 rounded-sm text-sm text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors font-sans font-semibold">
          <LogOut size={16} />
          Thoát Admin
        </Link>
      </div>
