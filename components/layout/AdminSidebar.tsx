  ...
  return (
    <aside className="w-60 bg-white border-r border-gray-200 flex flex-col h-full">
      ...
      <div className="p-3 border-t border-gray-200 space-y-0.5">
        <Link href="/landing" className="flex items-center gap-3 px-3 py-2.5 rounded-sm text-sm text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors font-heading font-semibold">
          <LogOut size={16} />
          Thoát Admin
        </Link>
      </div>
